...
package net.mcreator.alkahestry.item;
...
import net.mcreator.alkahestry.item.inventory.AlkahestPocketWatchInventoryCapability;
...
public class AlkahestPocketWatchItem extends Item {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openGui(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return new TextComponent("Alkahest's Pocket Watch");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new TestGrid1Menu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new AlkahestPocketWatchInventoryCapability();
	}
